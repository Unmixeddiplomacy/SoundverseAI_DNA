        ...
        <header className="relative w-full h-[160px] sm:h-[180px] md:h-[300px] lg:h-[200px] xl:h-[232px] flex flex-col py-4 mb-4 bg-[#0E0E0F] border-b border-[#383838] overflow-hidden">
            ...
            <div className="relative z-10 flex justify-between items-center w-full mt-2 lg:mt-[2px] sm:mt-4 px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative ml-auto">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full overflow-hidden cursor-pointer flex items-center justify-center group">
                    <img src="/user.png" alt="Profile" className="w-full h-full object-cover" />
                    {/* Tooltip for profile icon */}
                    <div className="hidden lg:block absolute right-0 top-full mt-2 z-50 opacity-0 group-hover:opacity-100 group-hover:scale-105 transition-all duration-200 pointer-events-none">
                      <div className="relative bg-gradient-to-r from-[#6A38D9]/90 to-[#8F6FFF]/90 p-[2.5px] rounded-xl shadow-xl">
                        <div className="relative bg-[#1F1F1F]/90 backdrop-blur-md rounded-lg px-4 py-2 text-white text-base font-extrabold border-2 border-[#8F6FFF] min-w-[120px] text-center drop-shadow-lg shadow-lg animate-pulse group-hover:animate-none">
                          Profile & Settings
                        </div>
                      </div>
                    </div>
