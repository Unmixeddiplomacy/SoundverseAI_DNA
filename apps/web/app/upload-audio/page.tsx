...
export default function UploadAudioPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen w-full bg-[#0e0e0f] overflow-x-hidden">
      <div className="flex flex-col flex-1 min-h-screen w-full">
        <TopBarUploadAudio />
        <div className="flex-1 overflow-y-auto w-full">
          <main className="flex flex-col px-2 xs:px-3 sm:px-4 md:px-6 lg:px-8 xl:px-[96px] py-2 xs:py-3 sm:py-4 gap-2 xs:gap-3 sm:gap-4 font-sans w-full">
